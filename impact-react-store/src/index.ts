...
type Convert<V, T extends Converter<V>> = ReturnType<ReturnType<T>["get"]>;

export function configureStore<U extends Converter<any>>(toObservableProp: U) {
