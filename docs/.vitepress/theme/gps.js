(function $csb$eval(require, module, exports, process, global, swcHelpers) {
  "use strict";
  (function (root, factory) {
    ...
    if (typeof define === "function" && define.amd)
      ...
      root.StackTraceGPS = factory(
        root.SourceMap || root.sourceMap,
        root.StackFrame,
      );
  })(void 0, function (SourceMap, StackFrame) {
    "use strict";
    /**
        ...
        req.onreadystatechange = function onreadystatechange() {
          if (req.readyState === 4) {
            if (
              ...
              reject(
                new Error("HTTP status: " + req.status + " retrieving " + url),
              );
          }
        };
        req.send();
        ...
        return new Promise(
          function (resolve1) {
            if (this.sourceMapConsumerCache[sourceMappingURL])
              resolve1(this.sourceMapConsumerCache[sourceMappingURL]);
            else {
              var sourceMapConsumerPromise = new Promise(
                function (resolve, reject) {
                  return this._get(sourceMappingURL)
                    .then(function (sourceMapSource) {
              ...
              resolve1(sourceMapConsumerPromise);
            }
          }.bind(this),
        );
      };
  ...
  //# sourceURL=https://r7nhz8-1234.csb.app/node_modules/stacktrace-gps/stacktrace-gps.js
});
